...
export default function Sidebar() {
  ...
  const sidebarItems: SidebarItem[] = [
    ...
    { name: "Custom AI Training", path: "/dashboard/custom-ai-training", icon: "psychology", isDashboardItem: true },
            ...
            { name: "Accessibility", path: "/dashboard/accessibility", icon: "accessibility", isDashboardItem: true },
            { name: "Enhanced Analytics", path: "/dashboard/enhanced-analytics", icon: "analytics", isDashboardItem: true },
            { name: "Analytics Reporting", path: "/dashboard/analytics-reporting", icon: "assessment", isDashboardItem: true },
            { name: "Real-time Analytics", path: "/dashboard/realtime-analytics", icon: "trending_up", isDashboardItem: true },
